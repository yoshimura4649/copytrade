...
<div class="myupload">
  ...
  <input type="file" name="<?php echo $name; ?>" id="<?php echo $id; ?>" hidden<?php if (isset($accept)) : ?> accept="<?php echo $accept; ?>" <?php endif; ?> <?php if (isset($max) && $max > 1) : ?> multiple data-rule-maxfiles="<?php echo $max; ?>" <?php endif; ?>>
  <ul class="p-0 m-0">
